  ...
  <div id="Checkout" class="inline">
      ...
      <form action="success.php" >
          ...
          <div class="form-group">
              ...
              <input id="NameOnCard" onkeydown="return /^[ A-Za-z_@./#&+-]*$/i.test(event.key)" class="form-control" type="text" maxlength="255" required></input>
          </div>
          <div class="form-group">
              <label for="CreditCardNumber">Card number</label>
              <input id="CreditCardNumber" class="null card-image form-control" type="number" required></input>
          </div>
          <div class="expiry-date-group form-group">
              <label for="ExpiryDate">Expiry date</label>
              <input id="ExpiryDate" class="form-control"  type="text" pattern="[0-9]{2}/[0-9]{2}" placeholder="MM / YY" maxlength="5"  size="5"required></input>
          </div>
          <div class="security-code-group form-group">
              <label for="SecurityCode">Security code</label>
              <div class="input-container" >
                  <input id="SecurityCode"  class="form-control" maxlength="3" size="3" type="text"  required></input>
          ...
          <div class="zip-code-group form-group">
              ...
              <div class="input-container">
                  <input id="ZIPCode" class="form-control" onkeydown="return /^[ 0-9]*$/i.test(event.key)" type="text" maxlength="10" required></input>
                  <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="left" data-content="Enter the ZIP/Postal code for your credit card billing address."><i class="fa fa-question-circle"></i></a>
              </div>
          </div>
          <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit">
              <span class="submit-button-lock"></span>
              <span class="align-middle">Pay<?php echo $amount;?></span>
          </button>
      </form>
  </div>
</div>
